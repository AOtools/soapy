...
setup(
    ...
    packages=['soapy', 'soapy.wfs', 'soapy.aotools', 'soapy.aotools.centroiders', 'soapy.aotools.circle',
              'soapy.aotools.fft', 'soapy.aotools.interp', 'soapy.aotools.interp', 'soapy.aotools.phasescreen',
              'soapy.aotools.wfs'],
    scripts=['bin/soapy'],
